...
public class DataSourceShadow implements DataSource, ShadowClass
{
    public static final Class<DataSource> shadowOf = DataSource.class;
    // Attr: org.intermine.model.bio.DataSource.name
    ...
    @Override public boolean equals(Object o) { return (o instanceof DataSource && id != null) ? id.equals(((DataSource)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "DataSource [description=\"" + description + "\", id=\"" + id + "\", name=\"" + name + "\", url=\"" + url + "\"]"; }
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.DataSource.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.DataSource.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.DataSourceShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.DataSource");
        if (name != null) {
            sb.append("$_^aname$_^");
            String string = name;
            while (string != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.DataSourceShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.DataSource)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.DataSource.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.DataSource.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
