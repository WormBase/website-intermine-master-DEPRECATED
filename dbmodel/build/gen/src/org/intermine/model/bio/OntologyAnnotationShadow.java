...
public class OntologyAnnotationShadow implements OntologyAnnotation, ShadowClass
{
    public static final Class<OntologyAnnotation> shadowOf = OntologyAnnotation.class;
    ...
    @Override public boolean equals(Object o) { return (o instanceof OntologyAnnotation && id != null) ? id.equals(((OntologyAnnotation)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "OntologyAnnotation [id=\"" + id + "\", ontologyTerm=" + (ontologyTerm == null ? "null" : (ontologyTerm.getId() == null ? "no id" : ontologyTerm.getId().toString())) + ", qualifier=\"" + qualifier + "\", subject=" + (subject == null ? "null" : (subject.getId() == null ? "no id" : subject.getId().toString())) + "]"; }
    ...
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.OntologyAnnotationShadow.class.equals(getClass())) {
