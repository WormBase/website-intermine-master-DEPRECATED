...
public class PublicationShadow implements Publication, ShadowClass
{
    ...
    @Override public String toString() { return "Publication [firstAuthor=\"" + firstAuthor + "\", id=\"" + id + "\", issue=\"" + issue + "\", journal=\"" + journal + "\", pages=\"" + pages + "\", pubMedId=\"" + pubMedId + "\", title=\"" + title + "\", volume=\"" + volume + "\", year=\"" + year + "\"]"; }
